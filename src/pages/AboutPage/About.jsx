...
const About = () => {
  ...
  return (
    <motion.section
      id="container"
      className="border border-whitebg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] text-gray-300 py-16 px-8 md:px-16 lg:px-32"
    >
      <div id="content" className="max-w-7xl mx-auto">
        <h2 id="heading" className="text-4xl font-bold text-white mb-6 text-center">
          <motion.span className="text-purple-400">About</motion.span> Me
        </h2>
...
<p id="paragraph-2" className="mb-4">
  ...
  <span className="text-purple-400">Tailwind CSS</span>, and RESTful APIs. From
