      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        {categories.map((category, idx) => (
          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8 bg-transparent ">
              {category.skills.map((skill, index) => (
                <motion.button
                  ...
                  key={index}
                  className="bg-white/10 cursor-none rounded-2xl p-6 shadow-lg flex flex-col items-center justify-center"
                >
  ...
  <div className=" text-white py-10" id="what-can-i-do">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-10">
        {services.map((service, index) => (
          <div key={index} className="p-6 rounded-lg shadow-lg bg-white/10 hover:bg-white/20 transition">
            <div className="text-5xl mb-4 text-center">{service.icon}</div>
            <h2 className="text-xl font-bold mb-4 text-center">{service.title}</h2>
